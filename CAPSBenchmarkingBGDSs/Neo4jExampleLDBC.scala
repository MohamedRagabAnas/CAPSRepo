...
object Neo4jExampleLDBC extends ConsoleApp{
  ...
  val neo4jResultsFilePath ="/home/cloudera/CAPSBenchMarking/Results/neo4jresults.txt"
  ...
  val timeQ19 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q19).records.show)
  writeToFile(neo4jResultsFilePath,"Q19:"+timeQ19.toString())

  val timeQ20 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q20).records.show)
  writeToFile(neo4jResultsFilePath,"Q20:"+timeQ20.toString())

  val timeQ21 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q21).records.show)
  writeToFile(neo4jResultsFilePath,"Q21:"+timeQ21.toString())

  val timeQ22 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q22).records.show)
  writeToFile(neo4jResultsFilePath,"Q22:"+timeQ22.toString())

  val timeQ23 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q23).records.show)
  writeToFile(neo4jResultsFilePath,"Q23:"+timeQ23.toString())

  val timeQ24 =Measurement.time( capsSession.cypher("FROM GRAPH CapsLDBCGraphNS.CapsLDBCGraph "+ queries. Q24).records.show)
  writeToFile(neo4jResultsFilePath,"Q24:"+timeQ24.toString())
