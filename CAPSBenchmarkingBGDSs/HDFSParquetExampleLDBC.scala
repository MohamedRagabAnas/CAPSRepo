...
object HDFSParquetExampleLDBC extends ConsoleApp{
  ...
  val parquetResultsFilePath ="/home/cloudera/CAPSBenchMarking/Results/Parquetresults.txt"
  ...
  val timeQ19 =Measurement.time( parquetGraph.cypher(queries.Q19).records.show)
  writeToFile(parquetResultsFilePath,"Q19:"+timeQ19.toString())

  val timeQ20 =Measurement.time( parquetGraph.cypher(queries.Q20).records.show)
  writeToFile(parquetResultsFilePath,"Q20:"+timeQ20.toString())

  val timeQ21 =Measurement.time( parquetGraph.cypher(queries.Q21).records.show)
  writeToFile(parquetResultsFilePath,"Q21:"+timeQ21.toString())

  val timeQ22 =Measurement.time( parquetGraph.cypher(queries.Q22).records.show)
  writeToFile(parquetResultsFilePath,"Q22:"+timeQ22.toString())

  val timeQ23 =Measurement.time( parquetGraph.cypher(queries.Q23).records.show)
  writeToFile(parquetResultsFilePath,"Q23:"+timeQ23.toString())

  val timeQ24 =Measurement.time( parquetGraph.cypher(queries.Q24).records.show)
  writeToFile(parquetResultsFilePath,"Q24:"+timeQ24.toString())
