...
object HDFSCSVLDBCMacroExample extends ConsoleApp{
  ...
  val csvResultsFilePath ="/home/cloudera/CAPSBenchMarking/ResultsAtomicLevel/CSVresults.txt"
  ...
  val timeQ10 =Measurement.time(csvGraph.cypher(queries.Q10).records.show)
  writeToFile(csvResultsFilePath,"Q10:"+timeQ10.toString())

  val timeQ11 =Measurement.time(csvGraph.cypher(queries.Q11).records.show)
  writeToFile(csvResultsFilePath,"Q11:"+timeQ11.toString())
  ...
  val timeQ16 =Measurement.time( csvGraph.cypher(queries.Q16).records.show)
  writeToFile(csvResultsFilePath,"Q16:"+timeQ16.toString())
