...
object HDFSORCLDBCMacroExample extends ConsoleApp{
  ...
  val orcResultsFilePath ="/home/cloudera/CAPSBenchMarking/ResultsAtomicLevel/ORCresults.txt"
  ...
  val timeQ10 =Measurement.time(orcGraph.cypher(queries.Q10).records.show)
  writeToFile(orcResultsFilePath,"Q10:"+timeQ10.toString())

  val timeQ11 =Measurement.time(orcGraph.cypher(queries.Q11).records.show)
  writeToFile(orcResultsFilePath,"Q11:"+timeQ11.toString())
  ...
  val timeQ16 =Measurement.time( orcGraph.cypher(queries.Q16).records.show)
  writeToFile(orcResultsFilePath,"Q16:"+timeQ16.toString())
